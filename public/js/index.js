...
(function () {
	...
	var calonOff = true;
	calbtns[1].addEventListener('mousemove',function(event){event.preventDefault();});
	document.getElementsByClassName('calmainTop')[0].addEventListener('mousemove',function(event){event.preventDefault();});
	setTime();
